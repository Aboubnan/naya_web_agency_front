...
const Footer = () => {
	return (
		<footer className="w-full bg-gray-800 text-white p-6 mt-8">
				...
				<div className="flex flex-col space-y-4">
					...
					>
						...
						>
							...
							<path d="M22 12a10 10 0 1 0-11.5 9.9v-7h-3v-3h3v-2.3c0-3 1.8-4.6 4.5-4.6 1.3 0 2.7.2 2.7.2v3h-1.5c-1.5 0-2 1-2 2v2.2h3.4l-.5 3h-2.9v7A10 10 0 0 0 22 12z" />
						</svg>
					</a>
